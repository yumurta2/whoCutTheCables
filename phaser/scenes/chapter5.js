    ...
    if(this.textArr[1] == false){
        ...
        switch(this.textArr[0]){
            ...
            case 2:
                ...
                break;
            case 3:
                this.text.setText('Sis:\n\n  Bro Wake Up!').setPosition(this.text.x,this.text.y);
                this.alsetP.setDepth(-4);
                this.sisP.setDepth(4);
                break;
            case 4:
                this.text.setText('Alset:\n\n  Did I fall asleep ?!').setPosition(this.text.x,this.text.y);
                ...
                break;
            case 5:
                this.text.setText('Sis:\n\n  Something turning on lights \n\n  We need to stop it').setPosition(this.text.x,this.text.y);
                this.alsetP.setDepth(-4);
                this.sisP.setDepth(4);
                break;
            case 6:
                this.text.setText('Alset:\n\n  Could it be me..?').setPosition(this.text.x,this.text.y);
                this.alsetP.setDepth(4);
                this.sisP.setDepth(-4);
                break;
            case 7:
                ...
                break;
            case 8:
                this.text.setText(`Alset:\n\n  nothing..\n\n  let's get started`).setPosition(this.text.x,this.text.y);
                this.alsetP.setDepth(4);
                this.sisP.setDepth(-4);
                break;
            case 9:
